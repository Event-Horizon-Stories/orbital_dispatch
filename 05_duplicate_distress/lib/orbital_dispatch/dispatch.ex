defmodule OrbitalDispatch.Dispatch do
  @moduledoc """
  The dispatch boundary for chapter 5.

  This module routes the stable public API into smaller submodules for repairs,
  launches, transfers, recurring patrol work, and duplicate-distress handling.
  """

  alias OrbitalDispatch.Dispatch.{Escorts, Launches, Patrols, Repairs, Transfers}
