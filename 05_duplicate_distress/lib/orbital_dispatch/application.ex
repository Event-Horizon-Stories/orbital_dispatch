defmodule OrbitalDispatch.Application do
  ...
  The runtime stays compact in chapter 5: a repo plus one Oban instance. The
  new duplicate-distress behavior comes from added workers and queue rules, not
  from a different OTP shape.
  """
