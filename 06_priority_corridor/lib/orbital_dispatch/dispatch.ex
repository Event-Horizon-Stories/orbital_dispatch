defmodule OrbitalDispatch.Dispatch do
  @moduledoc """
  The dispatch boundary for chapter 6.

  This module routes the stable public API into smaller submodules for repairs,
  launches, transfers, recurring patrol work, duplicate-distress handling, and
  corridor priority handling.
  """

  alias OrbitalDispatch.Dispatch.{Corridors, Escorts, Launches, Patrols, Repairs, Transfers}
